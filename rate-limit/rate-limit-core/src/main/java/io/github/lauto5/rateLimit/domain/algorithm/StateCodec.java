 ...
 * so that state can be persisted in a
 * {@link io.github.lauto5.rateLimit.application.ports.out.RateLimitStore}. Each
 * {@code RateLimitAlgorithm} provides the codec appropriate for its state type.
 *
